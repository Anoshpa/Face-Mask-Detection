...
def plot_accuracy_history(history):
    ...
    plt.plot(history.history['acc'], '#76b4bd', linewidth=3, solid_capstyle="round", linestyle='-', marker="8", markersize=6)
    plt.plot(history.history['val_acc'], '#d11141', linewidth=3, solid_capstyle="round", linestyle='-', marker="8", markersize=6)
